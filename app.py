...
app = Flask(__name__)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://zwkpvvfpyyxewl:08840ff2b2428b5296592ca05c9a84a8e5adac7ffb912e647f6d89f917dc8250@ec2-34-203-182-65.compute-1.amazonaws.com:5432/dc8e6j42j72qnr'
db = SQLAlchemy(app)
...
@login_required
def submit_post():
    post = Post(content = request.form['content'], title = request.form['title'], author_id = current_user.id)
    db.session.add(post)
    db.session.commit()
